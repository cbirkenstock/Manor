...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func fetchCurrentAuthSession(userName: String, password: String) {
        Amplify.Auth.fetchAuthSession { result in
            ...
            case .success(let session):
                ...
                if !session.isSignedIn {
                    let commaUserName = userName.replacingOccurrences(of: ".", with: ",")
                    self.signIn(username: commaUserName, password: password)
                }
